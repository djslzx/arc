...
if __name__ == '__main__':
    ...
    for n_lines in [1, 2, 3]:
        code = f'{n_examples}-RLP-{n_envs}e{n_lines}l{z_code}z'
    ...
    for mode in ['training', 'validation']:
        util.join_glob(f"{dir}/{n_examples}-RLP-{n_envs}e*l{z_code}z/{t}/{mode}_deltas.dat",
                       f"{dir}/{n_examples}-RLP-{n_envs}e1~3l{z_code}z/{t}/{mode}_deltas.dat")

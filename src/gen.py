...
def make_tf_exs(n_exs, n_envs, shape_types, scene_sizes, a_grammar, a_depth,
                fname=None, n_zs=(0, 0), enum_all_shapes=False, label_zs=True, n_processes=1):
    if fname is None:
        fname = make_name_code(n_exs=n_exs, scene_sizes=scene_sizes, shape_types=shape_types, n_zs=n_zs, n_envs=n_envs)
...
def make_discrim_exs_combi(n_exs, n_envs, shape_types, scene_sizes, a_grammar, a_depth,
                           fname=None, n_zs=(0, 0), enum_all_shapes=False, n_processes=1):
    """
...
if __name__ == '__main__':
    ...
    # make_tf_exs(n_exs=100, n_envs=1, shape_types=[Rect], scene_sizes=(1, 5), a_grammar=g, a_depth=1,
    #             n_zs=(0, 0), enum_all_shapes=False, label_zs=True, n_processes=8)
    # make_discrim_exs_combi(n_exs=10, n_envs=1, shape_types=[Rect], scene_sizes=(1, 5), a_grammar=g, a_depth=1,
    #                        fname=None, n_zs=(0, 0), enum_all_shapes=False, n_processes=16)
    for mode in ['train', 'test']:
        make_discrim_exs_model_perturb(
            ...
            fname=f'model-perturb-test-100-1~5r0z1e-{mode}',
